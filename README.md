...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="assets/activity-dark.svg?v=202608110228">
  <source media="(prefers-color-scheme: light)" srcset="assets/activity-light.svg?v=202608110228">
  <img src="assets/activity-dark.svg?v=202608110228" width="100%" alt="Contribution counters, streaks and a breakdown of languages by bytes of code.">
</picture>
...
<picture>
  <source media="(prefers-color-scheme: dark)" srcset="assets/oss-dark.svg?v=202608110228">
  <source media="(prefers-color-scheme: light)" srcset="assets/oss-light.svg?v=202608110228">
  <img src="assets/oss-dark.svg?v=202608110228" width="100%" alt="Pull requests to repositories I do not own, with merge counts and latest merged titles.">
</picture>
